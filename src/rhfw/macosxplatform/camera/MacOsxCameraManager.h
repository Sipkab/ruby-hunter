 ...
 */
/*
 * MacOsxCameraManager.h
 *
 *  Created on: 2016. dec. 10.
 *      Author: sipka
 */

#ifndef MACOSXPLATFORM_CAMERA_MACOSXCAMERAMANAGER_H_
#define MACOSXPLATFORM_CAMERA_MACOSXCAMERAMANAGER_H_

#include <framework/io/camera/CameraManager.h>

namespace rhfw {

class MacOsxCameraManager: public CameraManagerBase {
private:
...
#endif /* MACOSXPLATFORM_CAMERA_MACOSXCAMERAMANAGER_H_ */
