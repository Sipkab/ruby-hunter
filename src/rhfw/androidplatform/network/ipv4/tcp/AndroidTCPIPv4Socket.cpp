...
AndroidTCPIPv4Socket::AndroidTCPIPv4Socket() {
}
AndroidTCPIPv4Socket::AndroidTCPIPv4Socket(const TCPIPv4Address& address)
...
void AndroidTCPIPv4Socket::initialize() {
...
void AndroidTCPIPv4Socket::destroy() {
	ASSERT(fd >= 0);
...
TCPIPv4Connection* AndroidTCPIPv4Socket::acceptImpl() {
	sockaddr_in saddr;
