...
class OpenGlEs20ShaderProgramBase: public ShaderParentType {
protected:

	GLuint program = 0;
	OpenGlEs20Renderer* renderer;

	OpenGlEs20Renderer::VertexAttribArrayState* enableVertexAttribArray(GLint index) {
		return renderer->enableVertexAttribArray(index);
	}
	void disableStartingAt(OpenGlEs20Renderer::VertexAttribArrayState* vaa) {
...
public:
	OpenGlEs20ShaderProgramBase(OpenGlEs20Renderer* renderer)
