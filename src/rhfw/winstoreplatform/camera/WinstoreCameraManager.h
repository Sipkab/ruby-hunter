 ...
 */
/*
 * WinstoreCameraManager.h
 *
 *  Created on: 2016. dec. 10.
 *      Author: sipka
 */

#ifndef WINSTOREPLATFORM_CAMERA_WINSTORECAMERAMANAGER_H_
#define WINSTOREPLATFORM_CAMERA_WINSTORECAMERAMANAGER_H_

#include <framework/io/camera/CameraManager.h>

namespace rhfw {

class WinstoreCameraManager: public CameraManagerBase {
private:
...
#endif /* WINSTOREPLATFORM_CAMERA_WINSTORECAMERAMANAGER_H_ */
