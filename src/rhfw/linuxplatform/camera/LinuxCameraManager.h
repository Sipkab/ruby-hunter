 ...
 */
/*
 * LinuxCameraManager.h
 *
 *  Created on: 2016. dec. 10.
 *      Author: sipka
 */

#ifndef LINUXPLATFORM_CAMERA_LINUXCAMERAMANAGER_H_
#define LINUXPLATFORM_CAMERA_LINUXCAMERAMANAGER_H_

#include <framework/io/camera/CameraManager.h>

namespace rhfw {

class LinuxCameraManager: public CameraManagerBase {
private:
...
#endif /* LINUXPLATFORM_CAMERA_LINUXCAMERAMANAGER_H_ */
