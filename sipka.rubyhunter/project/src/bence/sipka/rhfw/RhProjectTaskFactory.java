...
public class RhProjectTaskFactory extends FrontendTaskFactory<Object> {
	...
	public ParameterizableTask<? extends Object> createTask(ExecutionContext executioncontext) {
		return new RHFrontendParameterizableTask() {
			...
			public String applicationNameOption;

			@Override
			protected TaskBuilderResult<?> createWorkerTask(TaskContext taskcontext) {
				return TaskBuilderResult.create(
						TaskIdentifier.builder(RhProjectWorkerTaskFactory.class.getName()).build(),
						new RhProjectWorkerTaskFactory(id, debugOption, applicationNameOption));
			}
		};
	}
